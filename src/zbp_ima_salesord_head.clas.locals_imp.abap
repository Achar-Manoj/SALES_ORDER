...
CLASS lsc_zima_salesord_head IMPLEMENTATION.
  ...
  METHOD save_modified.
    ...
    IF create-salesorder_item[] IS NOT INITIAL.

      ASSIGN create-salesorder_item TO FIELD-SYMBOL(<lfs_so_item>).

      lv_salesorder = create-salesorder_item[ 1 ]-Salesorder.

    ELSE.

      UNASSIGN <lfs_so_item>.

    ENDIF.

    IF update-salesorder_item[] IS NOT INITIAL.

      ASSIGN update-salesorder_item TO <lfs_so_item>.

      lv_salesorder = update-salesorder_item[ 1 ]-Salesorder.
    ...
    IF lv_salesorder IS NOT INITIAL AND <lfs_so_item> IS ASSIGNED.
      ...
      IF sy-subrc = 0.
        LOOP AT <lfs_so_item> ASSIGNING FIELD-SYMBOL(<lfs_salesorder_item>).
          IF <lfs_salesorder_item>-Salesorderitem IS INITIAL.
            lv_so_item_max = lv_so_item_max + 1.
            <lfs_salesorder_item>-Salesorderitem = lv_so_item_max.
          ENDIF.
      ...
      ELSE.
        CLEAR: lv_so_item_max.
        LOOP AT <lfs_so_item> ASSIGNING <lfs_salesorder_item>.
          IF <lfs_salesorder_item>-Salesorderitem IS INITIAL.
            lv_so_item_max = lv_so_item_max + 1.
            <lfs_salesorder_item>-Salesorderitem = lv_so_item_max.
          ENDIF.
